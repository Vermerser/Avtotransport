...
namespace Avtotransport
{
    ...
    /// Версия 1.3
    // Класс - параграф MS Word, обертка над обьектом Range который соответствует параграфу (вставленному в документ) 
    // Дает доступ к стилю текста, выравниваю, размеру шрифта (возможно дальнейшее расширение
    // По идее создается внутри класса документа при вставке абзаца как публичное свойство-обьект, 
